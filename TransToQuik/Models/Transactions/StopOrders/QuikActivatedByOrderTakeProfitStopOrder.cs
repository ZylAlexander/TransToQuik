...
public class QuikActivatedByOrderTakeProfitStopOrder : QuikTakeProfitStopOrderBase, IQuikActivatedByOrder
{
    /// <summary>
    ...
    public override QuikStopOrderKind StopOrderKind => QuikStopOrderKind.ActivatedByOrderTakeProfitStopOrder;
