...
public class QuikActivatedByOrderTakeProfitAndStopLimitOrder : QuikTakeProfitAndStopLimitOrder, IQuikActivatedByOrder
{
    ...
    public override QuikStopOrderKind StopOrderKind => QuikStopOrderKind.ActivatedByOrderTakeProfitAndStopLimitOrder;
